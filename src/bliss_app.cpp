...
void Bliss_App::run()
{
    ...
    Font font_roboto_mono = LoadFontEx("resources/fonts/RobotoMono-Regular.ttf", 28, nullptr, 255);
    Font font_roboto_mono_sm = LoadFontEx("resources/fonts/RobotoMono-Regular.ttf", 12, nullptr, 255);
    Font font = LoadFontEx("resources/fonts/Merriweather-Regular.ttf", 14, nullptr, 255);

    TraceLog(LOG_INFO, "Loading textures");
    Texture2D santa_tex = LoadTexture("resources/santa/Idle (1).png");
    ...
    while (!exit_window)
    {
        //Input handling
        //----------------------------------------------------------------------------------
        //Note: Input is actually polled inside raylib's EndDrawing
        {
